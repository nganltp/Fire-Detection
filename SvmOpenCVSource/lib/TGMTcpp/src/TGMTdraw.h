...
class TGMTdraw
{
	static void PutText(cv::Mat& img, cv::Point p, cv::Scalar color, float fontScale, char* text);
public:
	...
	static void DrawRectangle(const cv::Mat matInput, cv::Rect rect, cv::Scalar color = RED);
	static void DrawRectangle(const cv::Mat matInput, cv::Rect rect, cv::Scalar color, int thickness);
	static void DrawRectangle(const cv::Mat matInput, cv::Rect rect, cv::Scalar color, int thickness, int lineType);
	static void DrawRectangle(const cv::Mat matInput, cv::Rect rect, cv::Scalar color, int thickness, int lineType, int shift);
	...
	static void PutText(cv::Mat& img, cv::Point p, cv::Scalar color, const char* fmt, ...);
	static void PutText(cv::Mat& img, cv::Point p, cv::Scalar color, float fontScale, const char* fmt, ...);
